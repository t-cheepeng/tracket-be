...
(
    ...
    price_per_unit numeric(13, 6)           not null,
    ...
    fee            numeric(13, 6) default 0 not null,
    buy_id         integer
...
comment on column tracket.trade.price_per_unit is 'Price per unit. In standard decimal representation';
...
comment on column tracket.trade.fee is 'Fee. In standard decimal representation';
